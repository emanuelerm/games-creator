...
return [ 
	'champions' => [
		...
		[
			"name" => "ahri",
			"subname" => "la volpe a nove code",
			"derivation" => "shon-xan",
			"description" => "Legata alla magia del regno spirituale fin dalla sua nascita, Ahri è una misteriosa vastaya dalle fattezze di volpe, in grado di manipolare le emozioni delle sue prede e di consumarne l'essenza vitale. Quando lo fa, percepisce sprazzi dei ricordi e delle idee delle vittime. Un tempo era una potente ma capricciosa predatrice, ma ora viaggia nel mondo alla ricerca dei resti dei suoi antenati, cercando al tempo stesso di sostituire i ricordi rubati con i suoi.",
			"role" => "mago",
			"difficoulty" => "media",
		...
		[
			"name" => "akshan",
			"subname" => "la sentinella ribelle",
			"derivation" => "marwi",
			"description" => "Sprezzante del pericolo, Akshan lotta contro il male con carisma e sete di vendetta, rigorosamente a petto nudo. È abilissimo nell'arte del combattimento furtivo, evita gli sguardi nemici e riappare all'improvviso. Ha uno spiccato senso della giustizia e una leggendaria arma capace di sconfiggere la morte. Akshan raddrizza i torti di Runeterra vivendo secondo il suo codice morale: 'Non fare il bastardo.'",
			"role" => "tiratore",
			"difficoulty" => "bassa",
			"image" => "https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/blt58b3304a9d38b091/60f5d6e21929bc58854d00a6/072221_AkshanChampionTheme_Banner.jpg"
		],

		[
			"name" => "alistar",
			"subname" => "il minotauro",
			"derivation" => "runeterra",
			"description" => "Un possente guerriero con una reputazione temibile, Alistar cerca vendetta per lo sterminio del suo clan a opera dei noxiani. Pur ridotto in schiavitù e costretto a divenire un gladiatore, la sua indomita volontà gli ha impedito di ridursi a un animale. Ora, libero dalle catene dei suoi padroni, combatte in nome dei deboli e dei diseredati armato di corna, zoccoli, pugni e della sua rabbia.",
			"role" => "tank",
			"difficoulty" => "media",
		...
		[
			"name" => "amumu",
			"subname" => "la mummia triste",
			"derivation" => "shurima",
			"description" => "La leggenda racconta che Amumu, un'anima solitaria e malinconica originaria dell'antica Shurima, vaghi per il mondo alla ricerca di un amico. Vittima di un'antica maledizione, è condannato a vivere il resto della sua vita in solitudine. Il suo contatto porta morte e il suo affetto distruzione. Coloro i quali sostengono di averlo visto, descrivono Amumu come un cadavere vivente, piccolo e avvolto da bende. Amumu ha ispirato storie, canzoni e miti raccontati e tramandati di generazione in generazione, tanto da non riuscire più a separare ciò che è reale da ciò che non lo è.",
			"role" => "tank",
			"difficoulty" => "bassa",
		...
		[
			"name" => "aurelion sol",
			"subname" => "il forgiatore di stelle",
			"derivation" => "ignoto",
			"description" => "
			Poi, in un batter d'occhio di drago stellare, il mondo fu straziato da una serie di catastrofi stregate, e fu allora che Aurelion Sol capì che Targon e le odiate Incarnazioni erano senza difese. Con cautela provò a tornare e realizzò che la magia che lo vincolava si stava indebolendo. La corona iniziò a perdere pezzi d'oro che solcavano i cieli come comete.
			Spinto dalle infinite potenzialità della libertà e dalla voglia di vendicarsi, ora Aurelion Sol guarda Runeterra con una furia eterna. Certo, è proprio qui, in questo mondo, che l'equilibrio cosmico tornerà a pendere in suo favore. L'universo sarà testimone del destino di coloro che hanno osato rubare il potere di un forgiatore celeste.
			",
			"role" => "mago",
			"difficoulty" => "media",
		...
		[
			"name" => "bard",
			"subname" => "il custode errante",
			"derivation" => "Terre Antiche di Ionia",
		...
		[
			"name" => "brand",
			"subname" => "la vendetta ardente",
			"derivation" => "Freljord",
			"description" => "La creatura nota come Brand, un tempo nota come Kegan Rodhe, membro di una tribù del gelido Freljord, è una lezione sulla tentazione presentata dal potere assoluto. Durante la ricerca delle leggendarie Rune Terrene, Kegan tradì i suoi compagni e le tenne per se stesso. Un istante dopo smise di essere uomo.",
			"role" => "mago",
			"difficoulty" => "media",
		...
		[
			"name" => "Dr. Mundo",
			"subname" => "Il folle di Zaun",
			"derivation" => "Zaun",
			"description" => "Completamente folle, tragicamente omicida e orribilmente viola, Dr. Mundo è il motivo per cui molti cittadini di Zaun non escono di casa durante le notti più buie. Benché ora si sia autoproclamato dottore, un tempo era un paziente del più famigerato manicomio di Zaun. Dopo aver ''curato'' tutto il suo staff, Dr. Mundo ha stabilito la sua attività nei reparti vuoti dove un tempo veniva trattato e ha iniziato a imitare le procedure molto poco etiche a cui lui stesso è stato spesso sottoposto. Con un intero arsenale di medicinali a disposizione e nessuna conoscenza medica, ora diventa più mostruoso dopo ogni iniezione, terrorizzando i ''pazienti'' inermi che finiscono nelle vicinanze del suo laboratorio.",
			"role" => "Tank",
			"difficoulty" => "media",
		...
		[
			"name" => "Ekko",
			"subname" => "Il ragazzo che ha infranto il tempo",
			"derivation" => "Zaun",
	...
	'items' => [
		...
		[
			"name" => "speranza perduta",
			"cost" => "2900",
			"type" => "magic resistance"
		],

		[
			"name" => "annienatatore divino ",
			"cost" => "3400",
			"type" => "attacco fisico"
		],

		[
			"name" => "corazza spinata",
			"cost" => "3200",
			"type" => "anti guarigione / armatura"
		],

		[
			"name" => "arco scudo immortale",
			"cost" => "3400",
			"type" => "attacco fisigo / guarigione"
		],
	],
];
